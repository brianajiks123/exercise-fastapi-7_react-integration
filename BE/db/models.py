...
class Product(Model):
    ...
    unit_price = fields.DecimalField(max_digits=1000000, decimal_places=2, default=0.00)
    revenue = fields.DecimalField(max_digits=1000000, decimal_places=2, default=0.00)
